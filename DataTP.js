var ramadanDate = 11;
        ...
        var elements = document.querySelectorAll(".jadwal-2021__content div span")

        var next = document.querySelector("#jadwal-next");
        var prev = document.querySelector("#jadwal-prev");
