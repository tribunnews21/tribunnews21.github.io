...
function pilih_kota() {
    ...
    if (kota == 1) {
        ...
        geo = [-6.21154400, 106.84517200, 10.22];
        timezone = +7
    } else if (kota == 52) {
        ...
        geo = [-7.98189400, 112.62650300, 450.76];
        timezone = +7
    } else if (kota == 76) {
        ...
        geo = [-6.1494909, 113.8011693, 8];
        timezone = +7
    } else if (kota == 129) {
        geo = [-7.4472392, 112.6718017, 13];
        timezone = +7
    } else if (kota == 130) {
        geo = [-7.5340499, 112.2164841, 17];
        timezone = +7
    } else if (kota == 131) {
        geo = [-7.1572068, 112.6559225, 18];
        timezone = +7
    } else if (kota == 132) {
...
function jadwal_sholat() {
    ...
    if (timezone == +7) { tz = "WIB" } else if (timezone == +8) { tz = "WITA" } else if (timezone == +9) { tz = "WIT" } else tz = "";

    var html = '<div id="timetable">';
    // html += '<div></div><br>';
    // var html1 = '<table id="timetable">';
    // html1 = '<tr><th colspan="3">' + tanggal + '</th></tr><tr class="blank_row"><td colspan="3"></td></tr>';

    for (var i in list) {
        html += '<div class="jadwal">';
        html += '<div>' + list[i] + '</div>';
        html += '<div>' + times[list[i].toLowerCase()] + ' ' + '</div>';
        html += '</div>';
        html += '<div class="jadwal__line"></div>';
    };
    html += '</div>';
    document.getElementById('table-jdw-sholat').innerHTML = html;
    // document.getElementById('tanggal').innerHTML = html1;
}
